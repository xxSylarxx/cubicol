    ...
    <div class="container-fluid" id="cubicol">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-6">
                    <img src="./public/img/web/nosotros-equipo.png" width="100%" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    ...
                    <h2>Cubicol contribuyendo a la educación con tecnología</h2>
                    <p>Nosotros estamos 100% comprometidos con el
                        avance de la educación con tecnología a beneficio de miles
                        de estudiantes e instituciones educativas que lo necesitan.</p>
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-lg-4 my-4">
                    <div class="item">
                        <div class="icon mx-auto position-relative">
                            ...
                            <i style="position: absolute; z-index: 10;" class="fas fa-shield-alt fa-3x color1"></i>
                        </div>
                        <h3 class="titulo">Misión</h3>
                        <p class="texto">Brindar la mejor plataforma digital para la gestión educativa que optimice el trabajo, la experiencia de usuario y las comunicaciones de su institución, con los mejores estándares educativos.</p>
                ...
                <div class="col-lg-4 my-4">
                    <div class="item">
                        <div class="icon mx-auto position-relative">
                            ...
                            <i style="position: absolute; z-index: 10;" class="fas fa-binoculars fa-3x color2"></i>
                        </div>
                        <h3 class="titulo">Visión</h3>
                        <p class="texto">Ser reconocida como la plataforma de gestión educativa de mayor uso, siendo la primera a nivel nacional e internacional por el sector educativo.</p>
                        <!-- <a class="link" href="">VER MÁS</a> -->
                    </div>
                </div>
                <div class="col-lg-4 my-4">
                    <div class="item">
                        <div class="icon mx-auto position-relative">
                            ...
                            <i style="position: absolute; z-index: 10;" class="fas fa-heart fa-3x color3"></i>
                        </div>
                        <h3 class="titulo">Valores Corporativos</h3>
                        <p class="texto">Experiencia, seguridad y confiabilidad, calidad, compromiso, innovación, adaptabilidad e impacto educativo.</p>
                        <!-- <a class="link" href="">VER MÁS</a> -->
                    </div>
                </div>
            </div>
