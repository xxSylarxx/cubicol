                ...
                <div class="carousel-item active">
                    <div class="titleContainer">
                        <div class="animate__animated animate__fadeInDown">
                            <h2 class="title">Cubicol Institutos</h2>
                            <h2 class="title2">
                                Logra el registro de carreras, itinerarios, docentes y la comunicación en vivo con el alumnado.
                            </h2>
                            <div class="mt-4 mt-md-5">
                                <a class="btn" href="contacto">Solicita tu demo</a>
                            </div>
                        </div>
                    </div>
                    <img src="./public/img/web/portada-instituto.jpg">
                </div>
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-5">
                    ...
                    <p class="mt-4">
                        <b> Cubicol </b> institutos es la plataforma ideal que comunica a estudiantes, docentes y directivos con la más alta tecnología.
                    </p>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        ...
                        <h4 class="titulo my-3">Módulo Institutos</h4>
                        <p class="texto">
                            Permite registrar y hacer cambios de carreras, crear grupos de estudio, registrar notas creando registros configurables por carrera, genera cursos de recuperación, asistencia por QR y código de barras, proceso de matrícula, carnet de estudiante.
                            Visualiza el seguimiento del egresado, programación de horarios, emisión de reportes, actas y nóminas.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        ...
                        <p class="texto">
                            El estudiante se mantiene informado en tiempo real sobre el avance de sus cursos, material compartido en el aula virtual y comunicados de la institución.
                            Entre varias opciones están: mesa de partes, mensajería, encuestas, bolsa de empleo, muro de publicaciones y gestión de documentos.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        ...
                        <p class="texto">
                            Permite tener el control de los interesados y postulantes, cumpliendo un flujo de inscripción desde la página web o directamente en registro a la plataforma ya sea por visita o llamada. Puede registrar y llevar el control de un seguimiento completo incluyendo también entrega de documentos, agendar entrevistas y evaluaciones propia del proceso.
                        </p>
                    </div>
                </div>
                <!-- <div class="col-lg-4 col-md-6">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        ...
                        <p class="texto">
                            Permite registrar todo tipo de comprobantes (boletas, facturas, recibos, notas de crédito), además de llevar el control de los ingresos y egresos, así como el control de los estados financieros.
                            Podrás asignar becas, descuentos, promociones y automatizar los pagos de las cuotas en el banco, verificación de voucher, control de stock, interfaz con sistemas contables y mucho más.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        ...
                        <h4 class="titulo my-3">Módulo CRM</h4>
                        <p class="texto">
                            Permite a la institución centralizar su base de datos de interesados obtenidas y gestionadas desde las redes y página web para poder designarlos a un ejecutivo de ventas y así realizar el seguimiento de su proceso hasta concretarse la venta. Reportes de ventas por producto, por equipo y más.
                        </p>
                    </div>
                </div>
                <!-- <div class="col-lg-4 col-md-6">
